...
const NavLinks = ({ handleCLick }) => (
  <div className='mt-10'>
    {links.map((item) => (
      ...
      items-center my-8 text-sm font-medium text-gray-200
      hover:text-cyan-400'
...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      py-10 px-4 bg-[#1b113b]'>
        <img src="/src/assets/images/novaLogo.png" alt="logo" className='w-full h-20 object-contain' />
        <NavLinks />
      </div>
